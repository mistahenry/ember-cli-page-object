...
let keyboardWithOperators = create(keyboard.extend({
...
let page = create({
  ...
  keys: keyboardWithOperators.extend({
...
moduleForAcceptance('Acceptance | extension and composition');


test('allows compose and extend', async function(assert) {
  await page
    .visit()
    .keys
    .clickOn('1')
